...
public class GameGridEditor : Editor
{
    ...
    {
        GameGrid myGrid = (GameGrid)serializedObject.targetObject;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("GENERATE") && EditorUtility.DisplayDialog("WARNING", "Attention, the contents of the cells will be destroyed, continue?", "yes", "no"))
        {
            GameGrid myGrid = (GameGrid)serializedObject.targetObject;
